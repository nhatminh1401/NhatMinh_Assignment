...
namespace API.Migrations
{
    ...
    [Migration("20220714083406_rattings")]
    partial class rattings
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Models.AddRating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("API.Models.AddRating", b =>
                {
                    b.HasOne("API.Models.Products.Product", "products")
                        .WithMany()
            ...
            modelBuilder.Entity("API.Models.Rating", b =>
                {
                    b.HasOne("API.Models.Products.Product", null)
                        .WithMany("ratings")
                        .HasForeignKey("ProductId");
                });
